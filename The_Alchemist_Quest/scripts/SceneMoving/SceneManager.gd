...
#func change_scene_with_delay(scene_path: String):
	...
	#current_transition = preload("res://The_Alchemist_Quest/scenes/SceneMoving/screen_transition.tscn").instantiate()
	...
	#Load new scene
	#get_tree().change_scene_to_file("res://The_Alchemist_Quest/scenes/Map/game.tscn") # MOVE TO NEW MAP
