...
func _ready():
	$CenterContainer/VBoxContainer/NewGameButton.pressed.connect(_on_new_game_button_pressed)
	$CenterContainer/VBoxContainer/ContinueButton.pressed.connect(_on_continue_button_pressed)
	$CenterContainer/VBoxContainer/TutorialButton.pressed.connect(_on_tutorial_button_pressed)
